...
// import { db, auth } from './firebase.js'; // ייבוא auth כאן בצורה נכונה
// import { collection, query, where, getDocs, doc, updateDoc, deleteDoc, getDoc } from 'firebase/firestore';
// import emailjs from 'emailjs-com'; // ייבוא EmailJS
...
//               <td>
//                 {!user.isApproved && <button onClick={() => approveUser(user.id)}>אשר</button>}
//                 {user.isSuspended ? (
